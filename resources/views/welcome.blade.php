                        ...
                        @if (Route::has('login'))
                            <div class="space-x-4">
                                ...
                                @else
                                    ...
                                    <a href="{{ route('register') }}" class="ml-2 text-sm text-teal-600 hover:text-teal-800 font-medium">Register Akun</a>
                                @endauth
                            </div>
                        @endif
                    </div>
            ...
            <div class="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center gap-12">
                <div class="max-w-2xl">
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('login') }}" class="bg-[#F39C12] text-white px-8 py-3 rounded-lg font-bold text-lg hover:bg-yellow-600 transition shadow-lg transform hover:-translate-y-1">
                            Akses Portal
                        </a>
        ...
        <section class="bg-[#00A39D] text-white py-16">
            <div class="max-w-4xl mx-auto text-center px-4">
                ...
                <div class="flex justify-center gap-4">
                    <a href="{{ route('login') }}" class="bg-white text-[#00A39D] px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition shadow-lg">
                        Masuk Sekarang
                    </a>
                </div>
            </div>

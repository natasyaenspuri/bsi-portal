        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-b-4 border-[#F39C12]">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($pendingRequests); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-b-4 border-[#00A39D]">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($totalRequests); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-b-4 border-green-500">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e($activeRekenings); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        new Chart(ctxStatus, {
            ...
            data: {
                ...
                datasets: [{
                    data: <?php echo json_encode($chartStatusData, 15, 512) ?>,
                    backgroundColor: [
...
<?php /**PATH /Users/natasyaekanandasoniapuri/Documents/bsionerequest/bsi-portal/resources/views/livewire/admin-stats.blade.php ENDPATH**/ ?>